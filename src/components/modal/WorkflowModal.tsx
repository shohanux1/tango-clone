...
const WorkflowModal = ({ isOpen, toggleModal }: WorkflowModalProps) => {
  return (
    ...
    >
      <h2 className="mt-2 text-gray-500 text-sm font-medium">
        Choose a tab to start capturing your Workflow:
      </h2>

      <div className="max-h-64 overflow-auto mt-6">
        <a
          href="#"
          className="flex items-center p-3 mb-3 text-base font-bold text-gray-900 rounded-lg border transiotion hover:bg-gray-200 group hover:shadow "
        >
          <svg
            aria-hidden="true"
            className="h-4"
